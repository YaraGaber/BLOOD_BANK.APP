...
class _EditProfileScreenState extends State<EditProfileScreen> {
          ...
          child: Stack(
            ...
            children: [
              if (_image != null)
                ...
                CachedNetworkImage(
                  imageUrl: _oldUser!.photoURL.toString(),
                  height: kProfileDiameter,
                  width: kProfileDiameter,
                  fit: BoxFit.cover,
              ...
              Container(
                ...
                child: const FaIcon(FontAwesomeIcons.upload, color: Colors.white, size: 16),   // upload
              ),
            ],
          ),
        ),
  ...
  Widget _nameField() => TextFormField(
        ...
        decoration: const InputDecoration(
          ...
          labelText: 'Name',
          prefixIcon: FaIcon(FontAwesomeIcons.person),       // person
        ),
      );
  ...
  Widget _emailField() => TextFormField(
        ...
        decoration: const InputDecoration(
          border: OutlineInputBorder(),
          labelText: 'Email',
          prefixIcon: FaIcon(Icons.email),     // email icon
        ),
      );
  ...
  Widget _bloodTypeSelector() => DropdownButtonFormField<String>(
        ...
        decoration: const InputDecoration(
          ...
          prefixIcon: FaIcon(Icons.bloodtype),     // bloodDrop icon
        ),
